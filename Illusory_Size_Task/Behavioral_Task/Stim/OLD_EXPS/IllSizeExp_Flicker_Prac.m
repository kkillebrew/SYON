...
function [options,data] = IllSizeExp_Flicker_Prac(options,data)
...
while 1
    switch instSwitch
        ...
        case 1
            ...
            % Draw stim
            phaseSwitch = 1;
            Screen('DrawTexture',options.windowNum,options.circTextures{2,1,phaseSwitch},[],squeeze(options.textureCoords_Corrected(2,1,:,1)));
        ...
        case 6
            ...
            for n=1:length(data.practice.rawdataPractice(data.practice.rawdataPractice(:,1)==2))
                ...
                Screen('DrawTexture',options.windowNum,options.circTextures{data.practice.rawdataPractice(n,1),...
                    data.practice.rawdataPractice(n,2),phaseSwitch},[],...
        ...
        case 7
            ...
            % Draw stim
            phaseSwitch = 1;
            Screen('DrawTexture',options.windowNum,options.circTextures{1,1,phaseSwitch},[],squeeze(options.textureCoords_Corrected(1,1,:,1)));
            Screen('Flip',options.windowNum);
