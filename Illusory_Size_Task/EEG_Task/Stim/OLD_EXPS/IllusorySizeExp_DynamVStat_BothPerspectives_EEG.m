...
function [] = IllusorySizeExp_DynamVStat_BothPerspectives_EEG()
...
options.datafile = [options.datafile '_StatVDyn_PerspChange'];
...
cd ../../Behavioral_Task/Stim/Ball_In_Hallway_Stimuli/ballHallwayTextures/SingleBall   % cd into the correct folder
...
for n=1:length(options.trialOrder)
    ...
    if options.practice.practiceBreak ~= 1
        ...
        if n==1
            Screen('DrawTexture',options.windowNum,options.circTextures_fixOnly{2,1,2,perspIdx},[],options.textureCoords);
            Screen('Flip',options.windowNum);
            WaitSecs(1);
        end
        ...
        Screen('DrawTexture',options.windowNum,options.circTextures{hallwayIdx,1,phaseIdx,farCloseIdx,1,perspIdx},[],options.textureCoords);
        ...
        Screen('DrawTexture',options.windowNum,options.circTextures{hallwayIdx,1,3-phaseIdx,farCloseIdx,fixChangeIdx,perspIdx},[],options.textureCoords);
                        ...
                        case 1   % Far
                            switch hallwayIdx
                                case 1   % Hallway
                                    switch perspIdx
                                        case 1   % up and right
                                            options.default(n) = 111;   % Far hallway no chanage up right
                                        case 2   % up and left
                                            options.default(n) = 112;    % Far hallway no chanage up left
                                    end
                                case 2   % No hallway
                                    switch perspIdx
                                        case 1   % up and right
                                            options.default(n) = 113;   % Far no hallway no chanage up right
                                        case 2   % up and left
                                            options.default(n) = 114;    % Far no hallway no chanage up left
                                    end
                            end
                        case 2   % Close
                            switch hallwayIdx
                                case 1   % Hallway
                                    switch perspIdx
                                        case 1   % up and right
                                            options.default(n) = 121;   % Close hallway no chanage up right
                                        case 2   % up and left
                                            options.default(n) = 122;    % Close hallway no chanage up left
                                    end
                                case 2   % No hallway
                                    switch perspIdx
                                        case 1   % up and right
                                            options.default(n) = 123;   % Close no hallway no chanage up right
                                        case 2   % up and left
                                            options.default(n) = 124;    % Close no hallway no chanage up left
                                    end
                            end
                    end
                case 2      % Fix change
                        ...
                        case 1   % Far
                            switch hallwayIdx
                                case 1   % Hallway
                                    switch perspIdx
                                        case 1   % up and right
                                            options.default(n) = 131;   % Far hallway chanage up right
                                        case 2   % up and left
                                            options.default(n) = 132;    % Far hallway chanage up left
                                    end
                                case 2   % No hallway
                                    switch perspIdx
                                        case 1   % up and right
                                            options.default(n) = 133;   % Far no hallway no chanage up right
                                        case 2   % up and left
                                            options.default(n) = 134;    % Far no hallway no chanage up left
                                    end
                            end
                        case 2   % Close
                            switch hallwayIdx
                                case 1   % Hallway
                                    switch perspIdx
                                        case 1   % up and right
                                            options.default(n) = 141;   % Close hallway chanage up right
                                        case 2   % up and left
                                            options.default(n) = 142;    % Close hallway chanage up left
                                    end
                                case 2   % No hallway
                                    switch perspIdx
                                        case 1   % up and right
                                            options.default(n) = 143;   % Close no hallway chanage up right
                                        case 2   % up and left
                                            options.default(n) = 144;    % Close no hallway chanage up left
                                    end
                            end
                    end                    
            end
        ...
        Screen('DrawTexture',options.windowNum,options.circTextures{hallwayIdx,1,3-phaseIdx,farCloseIdx,1,perspIdx},[],options.textureCoords);
