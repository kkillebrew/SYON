...
% TOTAL EXPERIMENT TIME OF 17.23 MINUTES W/ 3 BREAKS EVERY 110 TRIALS
...
for n=1:length(options.trialOrder)
    ...
    if options.practice.practiceBreak ~= 1
        ...
        hallwayIdx = options.varList(options.trialOrder(n),3);   % 1=Hallway, 2=Close
