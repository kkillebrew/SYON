...
function [] = IllusorySizeExp_GrayCirc_BothPersp_EEG()
    ...
    if options.practice.practiceBreak ~= 1
        if options.photodiodeTesting == 0
            ...
            if this_b
                ...
                data.blockAcc(blockCount) = nanmean(data.rawdata(blockCountArray(blockCount):blockCountArray(blockCount+1),8))*100;
