...
options.sp.left.spatialFrequency = 1/options.PPD;   % Spatial frequency in pixels
options.sp.left.gratPhase = options.sp.gratPhase(1);   % Phase - determined randomly
options.sp.left.contrast = options.sp.contrast;   % Full contrast
...
options.sp.right.spatialFrequency = 1/options.PPD;   % Spatial frequency in pixels
options.sp.right.gratPhase = options.sp.gratPhase(1);   % Phase - determined randomly
options.sp.right.contrast = options.sp.contrast;   % Full contrast
...
% Max value of G/B values is 65% of max value of red, based on monitor cal
% file. Changed in order to control the brightness of the blue stim.
options.sp.right.color = [0 .2562 .2562];
