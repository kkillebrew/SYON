...
data.aL = .5:.5:data.xL(end); % threshold prior range
...
if options.practice.practiceBreak ~= 1
    ...
    if options.analysisCheck == 1
        ...
        data.thresh.max_thresh = data.xL(end); % maximum theoretical threshold, exclude if outside % mps 20190730 max = data.xL(end)
