...
if exist(fullfile('../../IllContCounterBalance_15degDiam_45degDist_Behav.mat'),'file')
    load('../../IllContCounterBalance_15degDiam_45degDist_Behav','IllContCounterBalance');
else
    IllContCounterBalance.subjNum = options.subjID;
    IllContCounterBalance.condOrder = randi(2);
    save('../../IllContCounterBalance_15degDiam_45degDist_Behav','IllContCounterBalance');
end
...
%         imwrite(imageArray,'illCont_Stim_15degDiam_45degDist_20degTilt.tiff');
