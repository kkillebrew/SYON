...
if exist(fullfile('../../IllContCounterBalance_3degDiam_9degDist_Behav.mat'),'file')
    load('../../IllContCounterBalance_3degDiam_9degDist_Behav','IllContCounterBalance');
else
    IllContCounterBalance.subjNum = options.subjID;
    IllContCounterBalance.condOrder = randi(2);
    save('../../IllContCounterBalance_3degDiam_9degDist_Behav','IllContCounterBalance');
end
...
% Size variables
options.stim.circDia = 3;   % Diameter of the circle
options.stim.circDist = 9;   % Distance between the center points of each circle
...
%         imageArray = Screen('GetImage',options.windowNum);
%         imwrite(imageArray,'illCont_Stim_3degDiam_9degDist_15degTilt.tiff');
